"""
Django settings for bark_project project.
...
SECRET_KEY = 'django-insecure-17=@j-z-74-1+quqg0c*wr0b8zx6l+vo*0kj*e34vr03p6u%ln'
...
WSGI_APPLICATION = 'bark_project.wsgi.application'
...
_responsables_raw = os.environ.get('RESPONSABLES_EMAIL', '')
RESPONSABLES_EMAIL = [e.strip() for e in _responsables_raw.split(',') if e.strip()] or [
    'admi.bark@gmail.com',   # destinatario por defecto
]
